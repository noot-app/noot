...
<style>
  ...
  @media (max-width: 768px) {
    .rising-sun {
      ...
      background:
        radial-gradient(
          ellipse 120vw 80vh at center bottom,
          #ff6b35 0%,
          #ff8c42 20%,
          transparent 62%
        ),
        radial-gradient(
          ellipse 90vw 65vh at center bottom,
          #ff4500 0%,
          #ff6b35 20%,
          transparent 68%
        ),
        radial-gradient(
          ellipse 55vw 45vh at center bottom,
          #ff3000 0%,
          #ff4500 10%,
          transparent 48%
        );
  ...
  @media (max-width: 420px) {
    .rising-sun {
      ...
      background:
        radial-gradient(
          ellipse 130vw 90vh at center bottom,
          #ff6b35 0%,
          #ff8c42 18%,
          transparent 60%
        ),
        radial-gradient(
          ellipse 100vw 70vh at center bottom,
          #ff4500 0%,
          #ff6b35 22%,
          #ff8c42 38%,
          transparent 70%
