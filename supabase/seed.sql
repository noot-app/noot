...
-- Insert sample labels for testing
INSERT INTO public.labels (user_id, name, description, color)
VALUES 
-- Labels for monalisa@birki.io (pro user)
('a1b2c3d4-e5f6-7890-abcd-ef1234567890'::uuid, 'breakfast', 'Morning meal items', 'FF6B6B'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890'::uuid, 'healthy', 'Nutritious food choices', '4ECDC4'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890'::uuid, 'snack', NULL, 'FFE66D'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890'::uuid, 'protein', 'High protein foods', '95E1D3'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890'::uuid, 'meal-prep', 'Pre-prepared meals', 'A8E6CF'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890'::uuid, 'trigger-food', 'Foods that trigger negative responses', 'FF0000'),

-- Labels for alice@birki.io (free user)
('b2c3d4e5-f6a7-8901-bcde-f23456789abc'::uuid, 'lunch', 'Midday meal items', 'FF8B94'),
('b2c3d4e5-f6a7-8901-bcde-f23456789abc'::uuid, 'comfort-food', 'Comfort food choices', 'C7CEEA'),
('b2c3d4e5-f6a7-8901-bcde-f23456789abc'::uuid, 'quick-meal', 'Fast preparation meals', 'FFEAA7');
