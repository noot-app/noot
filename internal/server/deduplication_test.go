...
func (m *MockStore) GetUserByEmail(ctx context.Context, email string) (*storage.User, error) { return nil, nil }
func (m *MockStore) UpdateUser(ctx context.Context, user *storage.User) error { return nil }
func (m *MockStore) CreateConsumption(ctx context.Context, consumption *storage.Consumption) error { return nil }
func (m *MockStore) GetConsumption(ctx context.Context, id string) (*storage.Consumption, error) { return nil, nil }
func (m *MockStore) GetConsumptionForUser(ctx context.Context, userID, id string) (*storage.Consumption, error) { return nil, nil }
func (m *MockStore) GetPublicConsumption(ctx context.Context, id string) (*storage.Consumption, error) { return nil, nil }
func (m *MockStore) UpdateConsumption(ctx context.Context, consumption *storage.Consumption) error { return nil }
func (m *MockStore) DeleteConsumption(ctx context.Context, id string) error { return nil }
func (m *MockStore) GetConsumptionsByUser(ctx context.Context, userID string, limit, offset int) ([]*storage.Consumption, error) { return nil, nil }
func (m *MockStore) GetConsumptionsByUserSince(ctx context.Context, userID string, since time.Time) ([]*storage.Consumption, error) { return nil, nil }
func (m *MockStore) GetConsumptionsByUserDateRange(ctx context.Context, userID string, start, end time.Time, limit, offset int) ([]*storage.Consumption, error) { return nil, nil }
func (m *MockStore) GetNutritionSummary(ctx context.Context, userID string, start, end time.Time) (*storage.NutritionSummary, error) { return nil, nil }
func (m *MockStore) CreateConsumptionItem(ctx context.Context, item *storage.ConsumptionItem) error { return nil }
func (m *MockStore) GetConsumptionItems(ctx context.Context, consumptionID string) ([]*storage.ConsumptionItem, error) { return nil, nil }
func (m *MockStore) UpdateConsumptionItem(ctx context.Context, item *storage.ConsumptionItem) error { return nil }
func (m *MockStore) DeleteConsumptionItem(ctx context.Context, id string) error { return nil }
func (m *MockStore) DeleteConsumptionItemsByConsumption(ctx context.Context, consumptionID string) error { return nil }
func (m *MockStore) GetStaleItems(ctx context.Context, staleAfter time.Time) ([]*storage.Item, error) { return nil, nil }
func (m *MockStore) UpsertUserGoal(ctx context.Context, goal *storage.UserGoal) error { return nil }
func (m *MockStore) GetUserGoal(ctx context.Context, userID, name string) (*storage.UserGoal, error) { return nil, nil }
func (m *MockStore) GetUserGoals(ctx context.Context, userID string) ([]*storage.UserGoal, error) { return nil, nil }
...
func (m *MockStore) GetActiveGoalName(ctx context.Context, userID string) (*string, error) { return nil, nil }
func (m *MockStore) UpsertUserBiometrics(ctx context.Context, biometrics *storage.UserBiometrics) error { return nil }
func (m *MockStore) GetUserBiometrics(ctx context.Context, userID string) (*storage.UserBiometrics, error) { return nil, nil }
...
func (m *MockStore) GetLabel(ctx context.Context, userID, id string) (*storage.Label, error) { return nil, nil }
func (m *MockStore) ListLabels(ctx context.Context, userID string) ([]*storage.LabelWithUsage, error) { return nil, nil }
func (m *MockStore) ListConsumptionLabels(ctx context.Context, userID, consumptionID string) ([]*storage.Label, error) { return nil, nil }
func (m *MockStore) AssignConsumptionLabels(ctx context.Context, userID, consumptionID string, labelIDs []string) error { return nil }
func (m *MockStore) UnassignConsumptionLabel(ctx context.Context, userID, consumptionID, labelID string) error { return nil }
func (m *MockStore) ListConsumptionItemLabels(ctx context.Context, userID, consumptionItemID string) ([]*storage.Label, error) { return nil, nil }
func (m *MockStore) AssignConsumptionItemLabels(ctx context.Context, userID, consumptionItemID string, labelIDs []string) error { return nil }
func (m *MockStore) UnassignConsumptionItemLabel(ctx context.Context, userID, consumptionItemID, labelID string) error { return nil }
func (m *MockStore) GetConsumptionsByLabels(ctx context.Context, userID string, labelNames []string, matchAll bool, limit, offset int) ([]*storage.Consumption, error) { return nil, nil }
...
func (m *MockStore) GetEvent(ctx context.Context, userID, id string) (*storage.Event, error) { return nil, nil }
func (m *MockStore) ListEvents(ctx context.Context, userID string, options storage.EventListOptions) ([]*storage.Event, error) { return nil, nil }
func (m *MockStore) CreateEventType(ctx context.Context, eventType *storage.EventType) error { return nil }
func (m *MockStore) UpdateEventType(ctx context.Context, eventType *storage.EventType) error { return nil }
func (m *MockStore) DeleteEventType(ctx context.Context, userID, id string) error { return nil }
func (m *MockStore) GetEventType(ctx context.Context, userID, id string) (*storage.EventType, error) { return nil, nil }
func (m *MockStore) ListEventTypes(ctx context.Context, userID string) ([]*storage.EventType, error) { return nil, nil }
func (m *MockStore) GetEventTypeCounts(ctx context.Context, userID string) (map[string]int, error) { return nil, nil }
func (m *MockStore) ListEventLabels(ctx context.Context, userID, eventID string) ([]*storage.Label, error) { return nil, nil }
func (m *MockStore) AssignEventLabels(ctx context.Context, userID, eventID string, labelIDs []string) error { return nil }
func (m *MockStore) UnassignEventLabel(ctx context.Context, userID, eventID, labelID string) error { return nil }
...
func (m *MockStore) ListEventLinks(ctx context.Context, userID, eventID string) ([]*storage.EventLink, error) { return nil, nil }
func (m *MockStore) CreateAPIKey(ctx context.Context, apiKey *storage.APIKey) error { return nil }
func (m *MockStore) GetAPIKey(ctx context.Context, userID, id string) (*storage.APIKey, error) { return nil, nil }
func (m *MockStore) GetAPIKeyByPrefix(ctx context.Context, prefix string) (*storage.APIKey, error) { return nil, nil }
func (m *MockStore) ListAPIKeys(ctx context.Context, userID string) ([]*storage.APIKey, error) { return nil, nil }
...
func (m *MockStore) UpdateAPIKeyLastUsed(ctx context.Context, id string, lastUsed time.Time) error { return nil }
