...
describe('Supabase Configuration', () => {
  ...
  describe('environment validation', () => {
    ...
    it('should handle whitespace values', () => {
      ...
      const hasUrl = !!mockEnv.PUBLIC_SUPABASE_URL && mockEnv.PUBLIC_SUPABASE_URL.trim() !== '';
      const hasKey = !!mockEnv.PUBLIC_SUPABASE_ANON_KEY && mockEnv.PUBLIC_SUPABASE_ANON_KEY.trim() !== '';
