 ...
 */
export function formatGrams(value: number | null | undefined, decimals: number = 1): string {
 ...
 */
export function formatMilligrams(value: number | null | undefined, decimals: number = 1): string {
 ...
 */
export function formatMicrograms(value: number | null | undefined, decimals: number = 1): string {
