...
<div class="min-h-screen flex items-center justify-center bg-base-200 py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-md w-full space-y-8">
    ...
    <div class="space-y-4">
      ...
      >
        <span class="inline-flex items-center justify-center gap-2 whitespace-nowrap" class:opacity-0={githubLoading}>
    ...
    <div class="relative my-6">
      ...
      <div class="relative flex justify-center text-sm">
        <span class="px-2 bg-base-200 text-base-content/70">Or sign up with email</span>
      </div>
    </div>
