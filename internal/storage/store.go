...
// ConsumptionItem represents the relationship between a consumption and an item with nutrition snapshot
type ConsumptionItem struct {
	ID            string    `json:"id"`
	ConsumptionID string    `json:"consumption_id"`
	ItemID        *string   `json:"item_id,omitempty"` // Optional link to global items cache
	...
	// Snapshot nutrition for THIS SERVING (not per-100g)
