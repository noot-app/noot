...
export function sanitizeRedirect(path: string, fallback: string = DEFAULT_REDIRECT_PATH): string {
...
export function getRedirectParam(url: URL, fallback: string = DEFAULT_REDIRECT_PATH): string {
