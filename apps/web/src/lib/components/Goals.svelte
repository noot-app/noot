...
<div class="card bg-base-200 shadow-lg">
  <div class="card-body">
    ...
    <!-- Goal Selector - Only show for Pro users and when not in meal contribution mode -->
    {#if !showMealContribution && $isPro}
      <GoalSelector onGoalChanged={handleGoalChanged} />
    {:else if !showMealContribution && !$isPro && !isSharedView}
