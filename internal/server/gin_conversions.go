...
func convertInternalNutritionSummaryToAPI(internal *storage.NutritionSummary) api.NutritionSummary {
	...
	return api.NutritionSummary{
		...
		TotalIodineMcg:           float32(internal.TotalIodine),
		TotalMolybdenumMcg:       float32(internal.TotalMolybdenum),
		TotalChromiumMcg:         float32(internal.TotalChromium),
		TotalFluorideMg:          float32(internal.TotalFluoride),
		TotalChlorideMg:          float32(internal.TotalChloride),
		TotalBiotinMcg:           float32(internal.TotalBiotin),
		TotalPantothenicAcidMg:   float32(internal.TotalPantothenicAcid),
		TotalCholineMg:           float32(internal.TotalCholine),
		TotalMonounsaturatedFatG: float32(internal.TotalMonounsaturatedFat),
		TotalPolyunsaturatedFatG: float32(internal.TotalPolyunsaturatedFat),
		TotalOmega3AlaG:          float32(internal.TotalOmega3Ala),
		TotalOmega3EpaG:          float32(internal.TotalOmega3Epa),
		TotalOmega3DhaG:          float32(internal.TotalOmega3Dha),
		TotalOmega6G:             float32(internal.TotalOmega6),
		TotalAlcoholG:            float32(internal.TotalAlcohol),
		TotalCaffeineMg:          float32(internal.TotalCaffeine),
		TotalCreatineMg:          float32(internal.TotalCreatine),
